                ...
                @foreach($balitas as $b)
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{ route('kader.balita.destroy', $b->id_balita) }}" style="display:inline;">
                                @csrf @method('DELETE')
                    ...
                    <div class="modal fade" id="modalEdit{{ $b->id_balita }}" tabindex="-1">
                        <div class="modal-dialog">
                            <form method="POST" action="{{ route('kader.balita.update', $b->id_balita) }}">
                                @csrf @method('PUT')
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Edit Balita</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="number" name="berat_lahir" step="0.01" class="form-control" value="{{ $b->berat_lahir }}">
                                        </div>
                                        <div class="mb-2">
                                            <label>Panjang Lahir (cm)</label>
                                            <input type="number" name="panjang_lahir" step="0.01" class="form-control" value="{{ $b->panjang_lahir }}">
                                        </div>
                                        <div class="mb-2">
                                            <label>Orang Tua</label>
                                            <select name="id" class="form-select" required>
                                                @foreach($orangtuas as $user)
                                                    <option value="{{ $user->id }}" {{ $b->id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
        ...
        <form method="POST" action="{{ route('kader.balita.store') }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        <label>Berat Lahir (kg)</label>
                        <input type="number" name="berat_lahir" step="0.01" class="form-control">
                    </div>
                    <div class="mb-2">
                        <label>Panjang Lahir (cm)</label>
                        <input type="number" name="panjang_lahir" step="0.01" class="form-control">
                    </div>
                    <div class="mb-2">
                        <label>Orang Tua</label>
                        <select name="id" class="form-select" required>
